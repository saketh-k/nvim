  ...
  outputs = { self, nixpkgs, nixCats, ... }@inputs: let
    ...
    categoryDefinitions = { pkgs, settings, categories, extra, name, mkPlugin, ... }@packageDef: {
      ...
      lspsAndRuntimeDeps = {
        ...
        kickstart-debug = with pkgs;[ delve ];
        kickstart-lint =with pkgs; [ markdownlint-cli ];
      };
      ...
      startupPlugins = {
        ...
        kickstart-lint =with pkgs.vimPlugins; [ nvim-lint ];
        kickstart-autopairs = with pkgs.vimPlugins;[ nvim-autopairs ];
